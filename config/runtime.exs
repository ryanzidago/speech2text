...
#
#     PHX_SERVER=true bin/speech2text start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :speech2text, Speech2textWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :speech2text, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :speech2text, Speech2text.Mailer,
